...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.inty.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.inty.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.inty.api.** {
    <init>(...);
