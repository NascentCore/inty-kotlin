...
import com.inty.api.core.http.PhantomReachableClosingHttpClient
import com.inty.api.core.http.QueryParams
import com.inty.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `inty-kotlin-client-okhttp` or implement your own.
     *
    ...
    companion object {
        ...
        const val PRODUCTION_URL = "https://app.inty.cc"
    ...
    class Builder internal constructor() {
         ...
         */
        fun fromEnv() = apply {
            (System.getProperty("inty.baseUrl") ?: System.getenv("INTY_BASE_URL"))?.let {
                baseUrl(it)
            }
            (System.getProperty("inty.apiKey") ?: System.getenv("INTY_API_KEY"))?.let { apiKey(it) }
        }
