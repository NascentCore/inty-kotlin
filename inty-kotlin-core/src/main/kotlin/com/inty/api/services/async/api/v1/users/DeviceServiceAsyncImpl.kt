...
class DeviceServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    DeviceServiceAsync {

    private val withRawResponse: DeviceServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): DeviceServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): DeviceServiceAsync =
        DeviceServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            DeviceServiceAsyncImpl.WithRawResponseImpl(
