...
interface PlanService {
    ...
    /** @see list */
    fun list(requestOptions: RequestOptions): PlanListResponse =
    ...
    interface WithRawResponse {
         ...
         * the same as [PlanService.create].
         */
        @MustBeClosed
        fun create(
            params: PlanCreateParams,
        ...
        /** @see list */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): HttpResponseFor<PlanListResponse> =
            list(PlanListParams.none(), requestOptions)
    }
}
