...
class CharacterThemeServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    CharacterThemeService {

    private val withRawResponse: CharacterThemeService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): CharacterThemeService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): CharacterThemeService =
        CharacterThemeServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        CharacterThemeService.WithRawResponse {
        ...
        override fun withOptions(
            ...
            CharacterThemeServiceImpl.WithRawResponseImpl(
