...
interface CharacterThemeService {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): CharacterThemeService
    ...
    /** @see list */
    fun list(requestOptions: RequestOptions): ApiResponseListCharacterTheme =
        list(CharacterThemeListParams.none(), requestOptions)

    /**
     * A view of [CharacterThemeService] that provides access to raw HTTP responses for each method.
     */
    interface WithRawResponse {
         ...
         * same as [CharacterThemeService.list].
         */
        @MustBeClosed
        fun list(
            params: CharacterThemeListParams = CharacterThemeListParams.none(),
        ...
        /** @see list */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): HttpResponseFor<ApiResponseListCharacterTheme> =
            list(CharacterThemeListParams.none(), requestOptions)
    }
}
