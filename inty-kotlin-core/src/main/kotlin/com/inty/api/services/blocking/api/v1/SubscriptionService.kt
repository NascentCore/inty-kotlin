...
interface SubscriptionService {
    ...
    /** @see webhook */
    fun webhook(requestOptions: RequestOptions): SubscriptionWebhookResponse =
    ...
    interface WithRawResponse {
         ...
         * same as [SubscriptionService.webhook].
         */
        @MustBeClosed
        fun webhook(
            params: SubscriptionWebhookParams = SubscriptionWebhookParams.none(),
        ...
        /** @see webhook */
        @MustBeClosed
        fun webhook(requestOptions: RequestOptions): HttpResponseFor<SubscriptionWebhookResponse> =
            webhook(SubscriptionWebhookParams.none(), requestOptions)
    }
}
