...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DeviceRegisterParams].
         *
    ...
    /** A builder for [DeviceRegisterParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(deviceRegisterParams: DeviceRegisterParams) = apply {
            body = deviceRegisterParams.body.toBuilder()
            additionalHeaders = deviceRegisterParams.additionalHeaders.toBuilder()
            additionalQueryParams = deviceRegisterParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DeviceRegisterParams].
         *
         ...
         */
        fun build(): DeviceRegisterParams =
    ...
    private constructor(
        ...
        ) : this(token, requestId, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("token", token), requestId, additionalProperties.toMutableMap())
        }
        ...
        internal fun validity(): Int =
            (if (token.asKnown() == null) 0 else 1) + (if (requestId.asKnown() == null) 0 else 1)
        ...
        private val hashCode: Int by lazy { Objects.hash(token, requestId, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{token=$token, requestId=$requestId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeviceRegisterParams &&
            body == other.body &&
    ...
    override fun toString() =
        "DeviceRegisterParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
