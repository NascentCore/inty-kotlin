...
private constructor(
    ...
    ) : this(id, createdAt, userId, language, updatedAt, voiceEnabled, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, createdAt, userId, language, updatedAt, voiceEnabled, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "Settings{id=$id, createdAt=$createdAt, userId=$userId, language=$language, updatedAt=$updatedAt, voiceEnabled=$voiceEnabled, additionalProperties=$additionalProperties}"
}
