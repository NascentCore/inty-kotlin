...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ConfigRetrieveResponse =
            ConfigRetrieveResponse(code, data, message, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "ConfigRetrieveResponse{code=$code, data=$data, message=$message, additionalProperties=$additionalProperties}"
}
