...
private constructor(
    ...
    companion object {
        ...
        fun none(): ChatListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): ChatListParams =
            ChatListParams(limit, skip, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun hashCode(): Int =
        Objects.hash(limit, skip, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ChatListParams{limit=$limit, skip=$skip, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
