...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ReportUploadImageParams].
         *
    ...
    /** A builder for [ReportUploadImageParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(reportUploadImageParams: ReportUploadImageParams) = apply {
            body = reportUploadImageParams.body.toBuilder()
            additionalHeaders = reportUploadImageParams.additionalHeaders.toBuilder()
            additionalQueryParams = reportUploadImageParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ReportUploadImageParams].
         *
         ...
         */
        fun build(): ReportUploadImageParams =
            ReportUploadImageParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReportUploadImageParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ReportUploadImageParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
