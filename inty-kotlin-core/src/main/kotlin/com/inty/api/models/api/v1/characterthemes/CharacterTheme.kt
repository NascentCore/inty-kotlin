...
private constructor(
     ...
     */
    fun agents(): List<Agent>? = agents.getNullable("agents")
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            orderIndex: JsonField<Long> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.orderIndex] with a well-typed [Long] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        override fun toString() =
            "Agent{agentId=$agentId, orderIndex=$orderIndex, agent=$agent, additionalProperties=$additionalProperties}"
    }
