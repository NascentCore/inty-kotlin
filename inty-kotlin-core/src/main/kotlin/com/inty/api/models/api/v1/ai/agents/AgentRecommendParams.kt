...
private constructor(
    ...
    companion object {
        ...
        fun none(): AgentRecommendParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AgentRecommendParams]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AgentRecommendParams].
         *
    ...
    class Sort @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val CREATED_ASC = of("created_asc")

            val CREATED_DESC = of("created_desc")
