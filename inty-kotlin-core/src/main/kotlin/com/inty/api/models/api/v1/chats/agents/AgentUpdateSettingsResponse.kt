...
@JsonDeserialize(using = AgentUpdateSettingsResponse.Deserializer::class)
@JsonSerialize(using = AgentUpdateSettingsResponse.Serializer::class)
class AgentUpdateSettingsResponse
private constructor(
    ...
    fun validate(): AgentUpdateSettingsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentUpdateSettingsResponse &&
    ...
    override fun toString(): String =
        when {
            apiResponseChatSettings != null ->
                "AgentUpdateSettingsResponse{apiResponseChatSettings=$apiResponseChatSettings}"
            apiResponseDict != null ->
                "AgentUpdateSettingsResponse{apiResponseDict=$apiResponseDict}"
            _json != null -> "AgentUpdateSettingsResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid AgentUpdateSettingsResponse")
        }
    ...
    /**
     * An interface that defines how to map each variant of [AgentUpdateSettingsResponse] to a value
     * of type [T].
     */
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [AgentUpdateSettingsResponse] to a value of type [T].
         *
         * An instance of [AgentUpdateSettingsResponse] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw IntyInvalidDataException("Unknown AgentUpdateSettingsResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<AgentUpdateSettingsResponse>(AgentUpdateSettingsResponse::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): AgentUpdateSettingsResponse {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<ApiResponseChatSettings>())?.let {
                            AgentUpdateSettingsResponse(apiResponseChatSettings = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<ApiResponseDict>())?.let {
                            AgentUpdateSettingsResponse(apiResponseDict = it, _json = json)
                        },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> AgentUpdateSettingsResponse(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<AgentUpdateSettingsResponse>(AgentUpdateSettingsResponse::class) {

        override fun serialize(
            value: AgentUpdateSettingsResponse,
