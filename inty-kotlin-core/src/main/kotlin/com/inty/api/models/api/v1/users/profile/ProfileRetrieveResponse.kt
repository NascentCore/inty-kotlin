...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(profileRetrieveResponse: ProfileRetrieveResponse) = apply {
            code = profileRetrieveResponse.code
            data = profileRetrieveResponse.data
            message = profileRetrieveResponse.message
        ...
        fun build(): ProfileRetrieveResponse =
            ProfileRetrieveResponse(code, data, message, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "ProfileRetrieveResponse{code=$code, data=$data, message=$message, additionalProperties=$additionalProperties}"
}
