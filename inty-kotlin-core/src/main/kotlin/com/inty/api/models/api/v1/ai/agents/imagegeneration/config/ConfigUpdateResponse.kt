...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(configUpdateResponse: ConfigUpdateResponse) = apply {
            code = configUpdateResponse.code
            data = configUpdateResponse.data
            message = configUpdateResponse.message
        ...
        fun build(): ConfigUpdateResponse =
            ConfigUpdateResponse(code, data, message, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "ConfigUpdateResponse{code=$code, data=$data, message=$message, additionalProperties=$additionalProperties}"
}
