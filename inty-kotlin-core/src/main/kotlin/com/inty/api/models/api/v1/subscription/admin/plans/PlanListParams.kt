...
private constructor(
    ...
    fun includeInactive(): Boolean? = includeInactive
    ...
    class Builder internal constructor() {
        ...
        internal fun from(planListParams: PlanListParams) = apply {
            includeInactive = planListParams.includeInactive
    ...
    override fun hashCode(): Int =
        Objects.hash(includeInactive, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "PlanListParams{includeInactive=$includeInactive, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
