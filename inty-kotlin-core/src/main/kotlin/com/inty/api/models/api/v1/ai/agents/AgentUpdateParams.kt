...
private constructor(
     ...
     */
    fun _metaData(): JsonField<AgentMetaData> = body._metaData()
    ...
    companion object {
        ...
        fun none(): AgentUpdateParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        /** Agent 元数据模型 */
        fun metaData(metaData: AgentMetaData?) = apply { body.metaData(metaData) }
    ...
    private constructor(
        ...
        @JsonProperty("meta_data")
        @ExcludeMissing
        fun _metaData(): JsonField<AgentMetaData> = metaData
        ...
        class Builder internal constructor() {
            ...
            /** AI 角色可见性 */
            fun visibility(visibility: AgentVisibility?) =
                visibility(JsonField.ofNullable(visibility))
