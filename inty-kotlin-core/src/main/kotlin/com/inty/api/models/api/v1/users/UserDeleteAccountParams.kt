...
private constructor(
    ...
    companion object {
        ...
        fun none(): UserDeleteAccountParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [UserDeleteAccountParams]. */
        fun builder() = Builder()
    }

    /** A builder for [UserDeleteAccountParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(userDeleteAccountParams: UserDeleteAccountParams) = apply {
            body = userDeleteAccountParams.body.toBuilder()
            additionalHeaders = userDeleteAccountParams.additionalHeaders.toBuilder()
            additionalQueryParams = userDeleteAccountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UserDeleteAccountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UserDeleteAccountParams =
            UserDeleteAccountParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserDeleteAccountParams &&
            body == other.body &&
    ...
    override fun toString() =
        "UserDeleteAccountParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
