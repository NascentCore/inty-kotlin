...
private constructor(
    ...
    companion object {
        ...
        fun none(): ProfileRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): ProfileRetrieveParams =
            ProfileRetrieveParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ProfileRetrieveParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
