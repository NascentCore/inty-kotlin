...
class AgentUpdateChatSettingsParams
private constructor(
    ...
    companion object {
        ...
        fun none(): AgentUpdateChatSettingsParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of
         * [AgentUpdateChatSettingsParams].
         */
        fun builder() = Builder()
    }

    /** A builder for [AgentUpdateChatSettingsParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(agentUpdateChatSettingsParams: AgentUpdateChatSettingsParams) = apply {
            agentId = agentUpdateChatSettingsParams.agentId
            body = agentUpdateChatSettingsParams.body.toBuilder()
            additionalHeaders = agentUpdateChatSettingsParams.additionalHeaders.toBuilder()
            additionalQueryParams = agentUpdateChatSettingsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AgentUpdateChatSettingsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AgentUpdateChatSettingsParams =
            AgentUpdateChatSettingsParams(
                agentId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentUpdateChatSettingsParams &&
    ...
    override fun toString() =
        "AgentUpdateChatSettingsParams{agentId=$agentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
