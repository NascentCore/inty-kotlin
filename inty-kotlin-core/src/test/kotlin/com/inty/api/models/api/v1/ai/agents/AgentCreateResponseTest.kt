...
internal class AgentCreateResponseTest {
    ...
    fun create() {
        ...
        assertThat(agentCreateResponse.code()).isEqualTo(0L)
        assertThat(agentCreateResponse.data())
            .isEqualTo(
                AgentCreateResponse.Data.ofAgent(
                    Agent.builder()
                        .id("id")
                        .createdAt(0L)
                        .gender("gender")
        ...
        assertThat(agentCreateResponse.message()).isEqualTo("message")
    }
