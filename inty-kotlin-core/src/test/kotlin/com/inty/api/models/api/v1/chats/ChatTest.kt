    ...
    fun create() {
        val chat =
            Chat.builder()
                ...
                .agentOpening("agent_opening")
                .agentOpeningAudioUrl("agent_opening_audio_url")
        ...
        assertThat(chat.agentOpening()).isEqualTo("agent_opening")
        assertThat(chat.agentOpeningAudioUrl()).isEqualTo("agent_opening_audio_url")
