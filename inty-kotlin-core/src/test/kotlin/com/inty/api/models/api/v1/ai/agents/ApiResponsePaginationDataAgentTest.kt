...
internal class ApiResponsePaginationDataAgentTest {

    @Test
    fun create() {
        val apiResponsePaginationDataAgent =
            ApiResponsePaginationDataAgent.builder()
                .code(0L)
                .data(
                    ApiResponsePaginationDataAgent.Data.builder()
                        .addList(
                            Agent.builder()
                                .id("id")
                                .createdAt(0L)
                                ...
                                .metaData(
                                    Agent.MetaData.builder().comment("comment").score(0L).build()
                                )
        ...
        assertThat(apiResponsePaginationDataAgent.code()).isEqualTo(0L)
        assertThat(apiResponsePaginationDataAgent.data())
            .isEqualTo(
                ApiResponsePaginationDataAgent.Data.builder()
                    .addList(
                        Agent.builder()
                            ...
                            .mainPrompt("main_prompt")
                            .messageExample("message_example")
                            .metaData(Agent.MetaData.builder().comment("comment").score(0L).build())
                            .modePrompt("mode_prompt")
                            .opening("opening")
                            .openingAudioUrl("opening_audio_url")
                            .personality("personality")
        ...
        assertThat(apiResponsePaginationDataAgent.message()).isEqualTo("message")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedApiResponsePaginationDataAgent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(apiResponsePaginationDataAgent),
                jacksonTypeRef<ApiResponsePaginationDataAgent>(),
            )

        assertThat(roundtrippedApiResponsePaginationDataAgent)
            .isEqualTo(apiResponsePaginationDataAgent)
    }
}
