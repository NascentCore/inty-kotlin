...
internal class CharacterThemeAgentTest {

    @Test
    fun create() {
        val characterThemeAgent =
        ...
        assertThat(characterThemeAgent.agentId()).isEqualTo("agent_id")
        assertThat(characterThemeAgent.orderIndex()).isEqualTo(0L)
        assertThat(characterThemeAgent.agent())
            .isEqualTo(
                Agent.builder()
                    .id("id")
                    .createdAt(0L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedCharacterThemeAgent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(characterThemeAgent),
                jacksonTypeRef<CharacterThemeAgent>(),
            )

        assertThat(roundtrippedCharacterThemeAgent).isEqualTo(characterThemeAgent)
    }
}
