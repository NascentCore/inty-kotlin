...
internal class AgentTest {
    ...
    fun create() {
        ...
        assertThat(agent.version()).isEqualTo(0L)
        ...
        assertThat(agent.backgroundAnimated()).isEqualTo("background_animated")
        ...
        assertThat(agent.source()).isEqualTo(Agent.Source.USER_CREATED)
