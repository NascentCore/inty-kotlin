...
package com.inty.api.client.okhttp
...
/**
 * A class that allows building an instance of [IntyClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class IntyOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [IntyClientAsync]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): IntyClientAsync = builder().fromEnv().build()
    }

    /** A builder for [IntyOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.inty.api.core.jsonMapper]. The default is usually sufficient and rarely
         ...
         *
         * Defaults to the production environment: `https://app.inty.cc`.
         */
        ...
        /**
         * Returns an immutable instance of [IntyClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IntyClientAsync =
            IntyClientAsyncImpl(
                clientOptions
                    .httpClient(
