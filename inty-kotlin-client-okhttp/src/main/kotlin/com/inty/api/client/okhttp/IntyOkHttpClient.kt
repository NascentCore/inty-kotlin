...
/**
 * A class that allows building an instance of [IntyClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class IntyOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [IntyClient]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): IntyClient = builder().fromEnv().build()
    }

    /** A builder for [IntyOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [IntyClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IntyClient =
            IntyClientImpl(
                clientOptions
                    .httpClient(
